...
class UploadsController extends OlogAppController {
    ...
    function index() {
        ...
        $options = array(
            ...
            'param_name' => 'files',
            'max_file_size' => null, // The php.ini settings upload_max_filesize and post_max_size take precedence over this
            'min_file_size' => 1,
            'accept_file_types' => '/.+$/i',
    ...
    /**
     * POST an upload to the content repository and send the response back to the client. This is done so the user does not
     * have to accept any certificate. The URL is sent implicitly as a parameter.
     */
    function proxy() {
